  ...
  <div>
    <form id="burger-form" @submit="createBurger($event)">
      ...
      <div id="opcionais-container" class="input-container">
        ...
        <div class="checkbox-container" v-for="opcional in opcionaisdata" v-bind:key="opcional.id">
          <input type="checkbox" name="opcionais" v-model="opcionais" v-bind:value="opcional.tipo">
